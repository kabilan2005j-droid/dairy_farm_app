...
class _EditSaleScreenState extends ConsumerState<EditSaleScreen> {
  ...
  void initState() {
    ...
    _buyerNameController =
        TextEditingController(text: widget.sale.buyerName);
    _quantityController =
        TextEditingController(text: widget.sale.quantity.toString());
    _rateController =
        TextEditingController(text: widget.sale.ratePerLitre.toString());
    _totalAmountController =
        TextEditingController(text: widget.sale.totalAmount.toString());
    _notesController =
        TextEditingController(text: widget.sale.notes);
    _milkType =
        widget.sale.milkType.isEmpty ? 'COW' : widget.sale.milkType;
    _session =
        widget.sale.session.isEmpty ? 'Morning' : widget.sale.session;
    _paymentStatus = widget.sale.paymentStatus.isEmpty
        ? 'Paid'
  ...
  Future<void> _saveChanges() async {
    ...
    try {
      ...
      await ref.read(salesServiceProvider).updateSale(updatedSale);
