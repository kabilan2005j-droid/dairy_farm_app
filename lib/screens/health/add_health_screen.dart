...
class AddHealthScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<AddHealthScreen> createState() =>
      _AddHealthScreenState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                  ...
                  return Container(
                    ...
                    child: const Row(
                      children: [
                        ...
                        SizedBox(width: 8),
                        Text(
                          'No animals found. Add animals first!',
                          style:
                    ...
                    child: DropdownButton<String>(
                      ...
                      items: animals.map((animal) {
                        return DropdownMenuItem<String>(
                          value: animal.id,
                          child: Text(
                            '${animal.name} (${animal.animalType} - Tag: ${animal.tagNumber})',
                          ),
                        );
                      }).toList(),
                      onChanged: (value) {
            ...
            const SizedBox(height: 8),
            Row(
              children: ['Completed', 'Ongoing', 'Scheduled']
                  .map((s) {
                return Expanded(
